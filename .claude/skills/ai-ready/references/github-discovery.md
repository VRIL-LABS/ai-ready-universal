...
| PR review comments | `github-mcp-server-pull_request_read` on recent PRs | **Repeated review feedback = conventions that should be in copilot-instructions.md and/or CLAUDE.md** |
...
These mined conventions go directly into `copilot-instructions.md` and/or `CLAUDE.md` — turning repeated human review feedback into automated AI guidance, regardless of which agent the contributor uses.
